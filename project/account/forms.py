...
class SignupForm(forms.Form):
    ...
    username = forms.CharField(
        label=(""),
        max_length=30,
        widget=forms.TextInput(attrs={'placeholder': 'Username', 'class': 'input-medium'}),
        required=True
    )
    ...
    #)
    email = forms.EmailField(widget=forms.TextInput(attrs={'placeholder': 'Email', 'class': 'input-xlarge'}), required=True)
