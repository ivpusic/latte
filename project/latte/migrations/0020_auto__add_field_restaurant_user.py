...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('latte_restaurant', 'user',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('latte_restaurant', 'user_id')
    ...
    models = {
        ...
        'latte.product': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'restoraunts': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['latte.Restaurant']", 'null': 'True', 'through': "orm['latte.RestaurantProduct']", 'symmetrical': 'False'})
        },
